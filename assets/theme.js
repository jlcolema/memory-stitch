...
theme.Product = (function() {
  function Product(container) {
    ...
    if (getUrlParameter('variant') !== "") {
      this._filterThumbnails(this.variants.currentVariant)
    }
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    ...
    _filterThumbnails: function (variant) {
      ...
      $(this.selectors.productThumbs).slick('slickUnfilter');
      $(this.selectors.productThumbs).slick('slickFilter', function (index, thumb) {
        const title = thumb.getAttribute('title');
        return title.includes(variant.sku) || title.includes("(*)");
      });
    },
...
const mobileShopProducts = document.querySelector('.site-nav--has-dropdown > p')
mobileShopProducts.addEventListener('click', () => {
  mobileShopProducts.parentElement.classList.toggle('active')
  const mobileProducts = document.querySelector('.site-nav--has-dropdown .sndn.snd1')
  mobileProducts.classList.toggle('active')
})
